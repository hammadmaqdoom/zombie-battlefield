...
bool Game::init()
{
	...
	else
	{
		...
		//Create window
		gWindow = SDL_CreateWindow( "Zombie Battle Field", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN );
		if( gWindow == NULL )
		{
...
bool Game::loadMedia()
{
    ...
    gTexture = loadTexture("2D-Horizontal-Battle-Backgrounds3.png");
